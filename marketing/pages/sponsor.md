...
- **Multi-AI Harness Development** - Codex, Gemini, Codex integration
...
- **[cheddarfox-codex-marketplace](https://github.com/bybren-llc/cheddarfox-codex-marketplace)** - Plugin system for Codex
